...
// function versionFn(v1,v2){
//     v1 = v1.split('.');
//     v2 = v2.split('.');
//     const min = Math.min(v1.length,v2.length);
//     for(let i =0;i<min;i++){
//         if(v2[i] > v1[i] ){
//             return true;
//         }else{
...
//     }
//     addTask(timer,desc){
//         this.queue.push([timer,desc])
//     }
//     next(){
//         if(this.queue.length && this.queue.length<queue.maxNum){
//             this.workNum ++;
//             this.queue.shift()
...
//     }
//     start(){
//         const {maxNum,queue} = this;
//         if(queue.length && maxNum<queue.length){
//             var [timer, desc] = this.queue.shift()
//             this.workNum++;
//             setTimeout(()=>{
//                 this.workNum --;
//             },timer)
...
//     scheduler.addTask(timeout(time).then(()=>{console.log(order)}))
// }
